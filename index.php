...
<meta name="theme-color" content="#263238"/>
    <link rel="apple-touch-icon" href="./images/swipe.png">
    <link rel="icon" type="image/png" sizes="32x32" href="./images/swipe.png">
    <link rel="icon" type="image/png" sizes="16x16" href="./images/swipe.png">
<link rel="shortcut icon" type="image/x-icon" href="./images/swipe.png" />
...
<link rel='stylesheet' href='./css/v3.3.1_mapbox.css'/>
<link rel="stylesheet" href="./css/styles.css"/>
<link  rel="stylesheet" href="./css/fontawesome/css/fontawesome.css"/>

<script  src='./js/v3.3.1_mapbox.js'></script>
...
<div>
<button onclick="choosepointlayer()" class="btn" value="nearestfunction" id="nearestfunction" style="display:none;"> Find distance by layer</button>
</div>

<br>

<div>
<button onclick="choosevoronoilayer()" class="btn" value="voronoifunction" id="voronoifunction" style="display:none;">Create voronoi Polygons</button>
</div>
...
<div>
<button onclick="initializenetwork()" class="btn" value="pathnetworkfunction" id="pathnetworkfunction" style="display:none;">Find path on road network</button>
</div>
...
<div id= "countfeatures">identify</div>
