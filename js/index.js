...
let bridgelayer = new L.geoJson(null, {
    ...
    pointToLayer: function pointToLayer(feature, latlng) {
        ...
        } else if (feature && feature.properties.index.indexOf("null") > -1) {
        ...
        } else if (feature && feature.properties.index.indexOf("") > -1) {
    ...
    onEachFeature: function onEachFeature(feature, layer) {
        ...
        {
            let popupContent = "" + feature.properties.index;
